...
def trainClassifier(X, Y, weight, bias, inEta, epochTime):
    totalUpdates = 0;
    for row, y in zip(X, Y):
        eta = inEta/(epochTime + 1)
    ...
    for eta in etas:
        ...
        for keepOut in range(5):
            ...
            for epoch in range(10):
                ...
                # Training the classifier.
                fWeight, fBias, updates, epochtime = trainClassifier(Xtrain, Ytrain, fWeight, fBias, eta, epochtime)
